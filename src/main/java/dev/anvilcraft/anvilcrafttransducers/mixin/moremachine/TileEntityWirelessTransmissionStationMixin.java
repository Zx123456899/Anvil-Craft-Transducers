...
@Mixin(TileEntityWirelessTransmissionStation.class)
public class TileEntityWirelessTransmissionStationMixin extends TileEntityConfigurableMachine implements IPowerConsumer {
    @Shadow
    MachineEnergyContainer<TileEntityWirelessTransmissionStation> energyContainer;
    @Unique
    private PowerGrid grid = null;

    public TileEntityWirelessTransmissionStationMixin(net.minecraft.core.Holder<net.minecraft.world.level.block.Block> blockProvider, BlockPos pos, BlockState state) {
